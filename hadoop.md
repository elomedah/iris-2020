...
L'interface web hadoop namenode http://localhost:9870    
L'interface web hadoop datanode  http://localhost:9864    
L'interface web yarn (resource manager) : http://localhost:8088   
L'interface web yarn (node manager) : http://localhost:8042   
